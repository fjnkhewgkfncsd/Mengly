...
const Header = () => {
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between  px-8 dark:bg-[171c27] xl:h-[100px] lg:h-[90px]">
                <Link to='home' smooth={true} duration={500} className="cursor-pointer text-lg font-semibold flex items-center justify-center">
                    <span className="text-blue-500 text-3xl">&lt;</span>
                    <span className='mx-2 dark:text-white xl:text-2xl lg:text-lg' style={{fontFamily: 'Agustina, sans-serif'}}>Heng Mengly</span>
                    <span className="text-blue-500 text-3xl">/&gt;</span>
                </Link>
                <div className='flex xl:gap-16 dark:text-white lg:gap-8'>
                    <Link to='skills' smooth={true} duration={500} className='cursor-pointer '>
                        <span className='xl:text-xl lg:text-md' style={{ fontFamily: 'Montserrat, sans-serif' }}>Skills</span>
                    </Link>
                    ...
                    <Link to='experiences' smooth={true} duration={500} className='cursor-pointer '>
                    ...
                    <Link to='education' smooth={true} duration={500} className='cursor-pointer '>
                        <span className='xl:text-xl lg:text-md' style={{ fontFamily: 'Montserrat, sans-serif' }}>Education</span>
                    </Link>
                    <Link to='projects' smooth={true} duration={500} className='cursor-pointer '>
                        <span className='xl:text-xl lg:text-md' style={{ fontFamily: 'Montserrat, sans-serif' }}>Projects</span>
                    </Link>
                    ...
                    <label className='relative xl:w-14 lg:w-12 lg:h-6 xl:h-8 rounded-full bg-gray-300 shadow-inner cursor-pointer transition-all duration-300' >
